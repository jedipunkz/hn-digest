...
hn_url: "https://news.ycombinator.com/item?id=48347525"
...
author: "vitchenkokir"
captured_at: "2026-06-01T00:27:25Z"
capture_tool: "hn-digest"
hn_id: 48347525
score: 3
comments: 0
posted_at: "2026-05-31T17:21:19Z"
tags:
  - hacker-news
  - translated
---
...
- HN: [48347525](https://news.ycombinator.com/item?id=48347525)
- Source: [github.com](https://github.com/GrillKit/grillkit)
- Score: 3
- Comments: 0
- Posted: 2026-05-31T17:21:19Z

## Translation

タイトル: GrillKit – 音声による技術インタビュー用の自己ホスト型 AI トレーナー
...
インタビュー — マルチトラック設定、セッションごとに複数のトピック、Web

ソケット Q&A、AI スコア 1 ～ 5、質問ごとに最大 2 つのフォローアップ
...
初回の流れ
構成 ( /config ) — 1 つ以上の Op を追加します

enAI 互換モデルをカタログに追加し、インタビュー モデルを選択し、インタビュー ロケールを設定します。接続をテストして保存します。
...
発売履歴
セキュリティ
SECURITY.md の説明に従って脆弱性を報告します。 Securi の公開問題を開かないでください

問題。
Apache License 2.0 (「通知」も参照)
