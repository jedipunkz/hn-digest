...
hn_url: "https://news.ycombinator.com/item?id=48546483"
title: "AI and Amateurism"
article_title: "Pluralistic: AI and amateurism (15 Jun 2026) – Pluralistic: Daily links from Cory Doctorow"
author: "samizdis"
captured_at: "2026-06-15T21:55:41Z"
capture_tool: "hn-digest"
hn_id: 48546483
score: 5
comments: 1
posted_at: "2026-06-15T20:17:07Z"
tags:
  - hacker-news
  - translated
---
...
- HN: [48546483](https://news.ycombinator.com/item?id=48546483)
- Source: [pluralistic.net](https://pluralistic.net/2026/06/15/vernacular/#hypercardian)
- Score: 5
- Comments: 1
- Posted: 2026-06-15T20:17:07Z

## Translation

タイトル: AIとアマチュアリズム
記事タイトル: 多元主義: AI とアマチュアリズム (2026 年 6 月 15 日) – 多元主義: Cory Doctorow からの毎日のリンク

記事本文:
多元主義: AI とアマチュアリズム (2026 年 6 月 15 日) – 多元主義: Cory Doctorow からの毎日のリンク
コンテンツにスキップ
多元主義: Cory Doctorow からの毎日のリンク
トラッカーも広告もありません。黒系、白地。プライバシー ポリシー: 当社はいかなる期間においてもデータを収集または保持しません。
多元主義: AI とアマチュアリズム (2026 年 6 月 15 日)
->->->->->->->->->->->->->->->->->->->->->->->->->->->->->
上位の情報源:
なし
-->
AI とアマチュアリズム : 生成コンテンツが日常的になるのはいつですか?
ねえ、これを見てください: 選ぶのが楽しいです。
オブジェクトの永続性：ディズニーキャラクター×きれいな下着。透明なポンティアック。 LED 首輪付き Makers v 犬。 MicrosoftがLinkedinを買収。正当な偉大さ。
今後の出演予定: LA、メンローパーク、トロント、ニューヨーク、フィラデルフィア、シカゴ、エディンバラ、サウスベンド。
最近の出演作：今まで行ってきたところ。
最新の本 : あなたは読み続けます、私は書き続けます。
今後の書籍 : 先ほども言いましたが、私は書き続けます。
AIとアマチュアリズム (固定リンク)
週末、私は近々出版予定の著書『The Reverse Centaur's Guide to Life After AI』（より優れた AI 評論家になることについての本）についてインタビューをしました。そして、インタビュアーは、私の人口統計と職歴に基づいて、私が AI ブースターではないことに驚いたと言いました。
https://us.macmillan.com/books/9780374621568/thereversecentaursguidetolifeafterai/
彼女がどこから来たのかが分かりました。私がコンピューターに出会ったのは、1970 年代半ば、幼少の頃でした。私の最初のコンピューターは CARDIAC で、完全に段ボールで作られたチューリング完全な機械式コンピューターで、私は延々とそれを使いました。
https://www.instructables.com/CARDIAC-CARDboard-Illustrative-Aid-to-Computation-/
その後、トロント大学のミニコンピューターに接続されたテレタイプ端末と音響カプラーを卒業しました。幼稚園の先生だった私の母は、よく家に密航していました 1

子供用トイレからのペーパータオルの千ロール。私は片側を 1,000 フィート上にコンピュータを動かし、次に反対側を 1,000 フィート下に移動してから、ペーパー タオルを慎重に巻き直し、子供たちが手を拭くためにバスルームに戻せるようにしました。
その後、1979 年に Apple ][+ を購入し、その後すぐにモデムを購入しました。それで終わりでした。私は一生その虜になりました。私はアマチュア プログラマーになり、その後プロのプログラマーになりました。私はダイヤルアップ BBS でフォ​​ーラムを主催し、そこでソフトウェアを配布し、コンピュータをインターネットに接続したい見知らぬ人にサポートを提供しました。私は Gopher 開発者、次に Web 開発者、そして雇われ CIO として仕事に就き、中小企業をネットワーク化してネットに接続するのを手伝いました。最終的に、私はフリー/オープンソース ソフトウェアのスタートアップを共同設立し、その後、電子フロンティア財団でデジタル権利活動家として 25 年間活動しました。そして、その期間のほとんどの間、私は精力的に SF を執筆し、最終的には「ポストサイバーパンク」と呼ばれることもある学校に関わるようになりました。
https://en.wikipedia.org/wiki/Rewired:_The_Post-Cyberpunk_Anthology
このすべての作品にエネルギーを与えた力は弁証法的なものであり、サイバーパンク文学そのものを動かした矛盾でした。サイバーパンクは間違いなく新しいテクノロジーのクールさと可燃性に魅了されていましたが、テクノロジーがどのように抑圧、監視、制御の力となり得るかについても恐怖を感じていました。ウィリアム・ギブソンが言うように、「サイバーパンクは警告であって、提案ではなかった」。
もちろん、ギブソンのより有名な言葉は、「ストリートは物事の独自の用途を見つける」です。ギブソンの小説 (そして私自身のテクノロジー人生でも) で最も興味深い出来事はすべて、テクノロジーのユーザー (多くの場合、正式な訓練や資格を持たない) が、自分のテクノロジーを適応させる方法を見つけたときに起こります。

ニーズに合わせて使用します。
https://pluralistic.net/2026/03/17/technopolitics/#original-sin
これが、私がハイパーカード、スクラッチ、およびプログラマーでない人でも自分の要望に正確に適合するソフトウェアを作成できるように設計されたその他のメタツールの熱烈なファンであり続ける理由です。これらのツールによって作成されたアプリが洗練性や効率性に欠けているとしても、これらのツールが日常の人々に、依存しているツールを直接制御する権限を与えているという事実によって、それは十分に相殺されます。
「認識論的な謙虚さ」が何らかの意味を持つとすれば、それは、ユーザーが自分のニーズを正確に把握できるのと同じくらい、自分とはまったく異なる人々のニーズをどれだけ「要件収集」しても把握できないことを認識することを意味します。独自のソフトウェアを作成するためのツールを人々に提供することは、人々に代わって働く技術者が作ることができるものよりも、彼ら自身の手と心に適した、その土地特有の、特異な、手製のツールを常に作成することになります。
16 世紀のポーランドで生まれ、現代の障害者の権利運動で取り上げられた「私たちなしでは私たちについて何もできない」という古代の格言は、人々が自分の生活条件をコントロールする権利と、自分のニーズを理解する人々の固有の能力を主張しています。使用するテクノロジーの設計についてコンサルティングを受けること以上に良いことがあるということをご存知ですか?そのテクノロジーを直接制御できるようになります。
これが、私がiPadに対して非常に疑念を抱いていた理由です。大いに賞賛された iPad の「使いやすさ」は、まさに iPad を使ってテクノロジーを利用するのがいかに簡単かということでした。しかし、iPad は依然として現代史上で最もユーザーにとってイノベーションに敵対的なテクノロジーであり、容赦のない多国籍企業の許可なしにテクノロジーを生産できないように設計されたデバイスです。これは警告ではなく、要求としてのサイバーパンクです。
https://memex.craphound.com/2010/0

4/01/なぜ iPad を買わないのか、そしてどちらも買うべきではないと思うのか/
私が生涯にわたって擁護してきたテクノロジーは、ユーザーにより詳細な制御を提供するテクノロジーです。私の不変の教訓の 1 つは、私と異なる人々は私が知ることができないことを知っており、彼らの独自の知識と視点から恩恵を受ける唯一の方法は、彼らが彼らにとって重要なことを自由に作成し共有することである、ということです。ダン・ギルモアが市民ジャーナリズムの研究を発明していた頃、「私の読者は私よりも多くのことを知っている」と述べたように、
https://www.oreilly.com/openbook/wemedia/book/ch00.pdf
そして、私は AI に対して広く非常に懐疑的であり、実稼働環境での「バイブ コーディング」ソフトウェアの急増に深く懸念していますが、個人プロジェクトのためのバイブ コーディングは、コンピューター ユーザーが自分のコンピューターがどのように動作するかを決定できるツールの系譜に追加される便利で刺激的なツールです。個人的なプロジェクトを作成している人にとって、vibe コーディングは、シェル スクリプト、cron ジョブ、Applescript、その他のデスクトップ オートメーション ツールの機能をより幅広いユーザーに拡張します。
先週、私の本について話をしたジャーナリストの一人は、飛行機が自宅の上空を通過するたびに警報を表示し、尾翼の番号やその他の飛行の詳細を知らせるアプリをバイブコーディングした方法について語った。これは私には必要も興味もない情報であり、したがって私が知ることに興奮しているのは、その存在自体が、世界には私とは楽しく、還元不可能で、驚くほど異なる人々で満ちており、さらに、彼らの独自のニーズは彼らの想像力とパーソナルコンピューターを使用して直接満たすことができることを裏付けるものだからです。
私は最近、同僚のナオミ・ノヴィクと話をしました。彼は優秀な作家であり、Archive of Our Own の共同設立者でもあります。ナオミは私のために AO3 のフォローアップをデモしました: Wreccer、小さなグループを見つけるのに役立つシステム

自分と似た趣味を持つ人たちを集めて、そのグループ内でのメディアの推奨を促進します。これは、大規模で集中化されたモノリシックなアルゴリズムによる推奨システムに代わる、個人的で関係性に基づく一種の代替手段です。
ナオミは、Wreccer はオリジナルの Twitter が採用していたものと同じ設計思想を使用して構築されていると語った。 Twitter が開始されたとき、それは最初に API であり、公式 Twitter フロントエンドはその API に基づいて構築されました。しかし、誰でも自分の望むように動作する Twitter 用の独自のフロントエンドを構築することができました。さて、この文では「誰でも」という単語が非常に重要な役割を果たしています。なぜなら、ほとんどの人は API が何なのかすら知りませんし、知っている人のほとんどが Twitter 用の独自のソフトウェア フロントエンドを書く能力がなかったからです。
しかし、Wreccer はバイブコーディングの時代に向けて設計されており、この API を使用すると、このサービスを使用する人は誰でも、便利だと思う機能を高めて中心に置き、興味のない機能を隠すなど、システムへの独自のインターフェイスを設計できるようになります。個人のカスタム フロントエンドには、他のデータ ソースを取り込むこともできます。たとえば、Mastodon メッセージを取り込んだり、自宅の上空を飛ぶ飛行機の尾翼番号を示すアラートを表示したりすることもできます。
これは私が非常に興奮しているバイブコーディングの部分ですが、業界が注目している部分ではありません。私たちは、個人的な自作のソフトウェア ユーティリティがそれ自体で終わりになり得るという話を聞く代わりに、商用製品コードのプロトタイプとしての雰囲気コード化されたプロジェクトについて聞きます。無知な上司が、サイロ化されたデスクトップ コンピューター上の 1 人のユーザーに対しては問題なく動作するソフトウェア製品やサービスをコーディングしているのに、公共のインターネット上の何百万人ものユーザーに対して同じものを動作させるのに、なぜ年間 50 人のエンジニアが必要なのか知りたいと要求するという話を聞きます。私たちは

何百万人ものユーザーがいるフリー/オープンソース ソフトウェア プロジェクトにコードを書き、パッチを提出し、セキュリティ上の脆弱性が満載の粗末なコードでプロジェクト管理者を圧倒している人々の話を聞きます。
もちろん、業界が製品コードを置き換えるバイブコード化されたソフトウェアの可能性に注目したいのには明らかな理由があります。 AI バブルは、ユニットエコノミクスが着実に悪化しているにもかかわらず、これまでに 1.4 兆ドルを消費し、年間わずか数百億ドルをもたらしています。
https://www.telegraph.co.uk/news/2026/06/04/ai-is-the-greatest-money-wasting-scheme-humanity-has-ever-i/
バブルを膨らませ続けるために、AI 詐欺師はテクノロジーに対する巨額の経済的利益を約束しなければなりません。彼らは、熟練した高賃金で需要の高い労働者である現役プログラマーがバイブコードに置き換わろうとしていると投資家に信じてもらいたいと考えている。彼らの売り文句は、AIのセールスマンと上司が共謀して100万ドル相当のプログラマーを解雇するごとに、その雰囲気コードをボットで吐き出すAI企業に50万ドルが入るというものだ。
これは、AI が私たちの生活をどのように一元化し、制御し、均質化するかに全面的に焦点を当てている AI バブルと同じです。初期のデスクトップ パブリッシング、ウェブ パブリッシング、ソーシャル メディアが、混沌として奇妙で違反的な趣味のメディアと網膜を焼きつくようなデザインの見事なごちゃごちゃを私たちに提供してくれたのに対し、AI アートとデザインは 1,000 ヤード離れていてもすぐに認識でき、すべてが同じで、退屈で、洗いざらされて見えます。
https://pluralistic.net/2024/07/20/ransom-note-force-field/#antilibraries
AI 企業は、自分のコンピューター上で実行できるオープンウェイト/オープンソース モデルをリリースしましたが、これらは余興やおもちゃ、デモとして扱われます。実際のアクションは「フロンティア モデル」にあると言われています。これは、業界用語で「次のようなソフトウェアの一部」を指します。

ランニングコストはほとんどの国のGDPを超えています。」
https://pluralistic.net/2026/02/19/now-we-are-six/#stock-buyback
おそらくこれが、AI のダイナミクスが初期の Web のダイナミクスと大きく異なる理由です。初期の Web ユーザーは労働者であり、上司に Web の使用を許可して、仕事をする人々により多くの権限を委譲するよう要求しました。対照的に、今日最も熱心に AI を推進しているのは上司であり、職務上 AI を十分に活用していない従業員を脅します。
https://pluralistic.net/2026/05/26/the-ai-will- continue/#until-morale-improves
AI の使用によって特異性が現れるのは、多くの場合ひどいものです。 AI は、あなたとチャットボットがチームを組んであなたの妄想を強化し、あなたを危険な蜃気楼の世界にさらに深く押し込むフォリ・ア・ウンの作成に役立ちます。
https://pluralistic.net/2026/06/03/mission-space/#gsd
初期のインターネットを擁護した人々について語られている（誤った）話があります。つまり、私たちはテクノロジーが良い方向への力になるだけだと軽々しく確信しており、テクノロジーが制御し、抽出し、害を及ぼす可能性には無関心だったということです。それは明らかに真実ではありません。「ストリートは物事の独自の用途を見つける」と「サイバーパンクは警告である」というサイバーパンクの二元論を思い出してください。
