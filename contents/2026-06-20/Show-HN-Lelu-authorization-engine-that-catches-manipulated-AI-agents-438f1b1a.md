---
source: "https://github.com/lelu-auth/lelu"
hn_url: "https://news.ycombinator.com/item?id=48608657"
title: "Show HN: Lelu – authorization engine that catches manipulated AI agents"
article_title: "GitHub - lelu-auth/lelu: Open source authorization engine for AI agents. Confidence-aware gating · Human-in-the-loop review · Policy-as-code · Full audit trail · GitHub"
author: "Abenezer0923"
captured_at: "2026-06-20T12:43:07Z"
capture_tool: "hn-digest"
hn_id: 48608657
score: 2
comments: 0
posted_at: "2026-06-20T12:10:42Z"
tags:
  - hacker-news
  - translated
---
...
- HN: [48608657](https://news.ycombinator.com/item?id=48608657)
- Source: [github.com](https://github.com/lelu-auth/lelu)
- Score: 2
- Comments: 0
- Posted: 2026-06-20T12:10:42Z

## Translation

タイトル: Show HN: Lelu – 操作された AI エージェントを捕捉する認証エンジン
記事タイトル: GitHub - lelu-auth/lelu: AI エージェント用のオープンソース認証エンジン。信頼性を意識したゲーティング · 人間参加型レビュー · コードとしてのポリシー · 完全な監査証跡 · GitHub
説明: AI エージェント用のオープンソース認証エンジン。信頼性を意識したゲーティング · 人間参加型レビュー · コードとしてのポリシー · 完全な監査証跡 - lelu-auth/lelu

記事本文:
GitHub - lelu-auth/lelu: AI エージェント用のオープンソース認証エンジン。信頼性を意識したゲーティング · 人間参加型レビュー · コードとしてのポリシー · 完全な監査証跡 · GitHub
コンテンツにスキップ
ナビゲーションメニュー
サインイン
外観設定
...
440 コミット 440 コミット .github .github config config docs docs エンジン エンジンの例 例 helm/ lelu helm/ lelu インフラストラクチャ インフラストラクチャ プラットフォーム プラットフォーム スクリプト スクリプト sdk sdk テスト/統合テスト/統合 .dockerignore .dockerignore .env.example .env.example .gitignore .gitignore CODE_OF_CONDUCT.md CODE_OF_CONDUCT.md CONTRIBUTING.md CONTRIBUTING.md ライセンス ライセンス README.md README.md SECURITY.md SECURITY.md docker-compose.production.yml docker-compose.production.yml docker-compose.yml docker-compose.yml すべてのファイルを表示 リポジトリ ファイルのナビゲーション
AI エージェント用の認可エンジン。
...
await searAlternative (決定 .safeTool 、決定 .safeA

rgs ) ; // サンドボックスにリダイレクトされる
} それ以外の場合は {
...
OpenAI 、 Anthropic 、 LangChain 、 LangGraph 、 Vercel AI SDK 、および MCP ですぐに使用できます。
...
AES-256-GCM で暗号化された (agent_id、user_id) ごとの資格情報ストレージ
8つの内蔵prによる自動更新

提供者 (Google、GitHub、Slack、Salesforce、Notion、Linear、Jira、Microsoft)
...
-e API_KEY=あなたのAPIキー\
ghcr.io/lelu-auth/lelu/engine:最新
# Helm (Kubernetes)
...
Open source authorization engine for AI agents. Confidence-aware gating · Human-in-the-loop review · Policy-as-code · Full audit trail - lelu-auth/lelu

GitHub - lelu-auth/lelu: Open source authorization engine for AI agents. Confidence-aware gating · Human-in-the-loop review · Policy-as-code · Full audit trail · GitHub
Skip to content
Navigation Menu
Sign in
Appearance settings
...
440 Commits 440 Commits .github .github config config docs docs engine engine examples examples helm/ lelu helm/ lelu infrastructure infrastructure platform platform scripts scripts sdk sdk tests/ integration tests/ integration .dockerignore .dockerignore .env.example .env.example .gitignore .gitignore CODE_OF_CONDUCT.md CODE_OF_CONDUCT.md CONTRIBUTING.md CONTRIBUTING.md LICENSE LICENSE README.md README.md SECURITY.md SECURITY.md docker-compose.production.yml docker-compose.production.yml docker-compose.yml docker-compose.yml View all files Repository files navigation
