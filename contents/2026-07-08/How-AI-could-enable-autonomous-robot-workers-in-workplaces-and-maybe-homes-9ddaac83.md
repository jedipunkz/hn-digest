---
source: "https://arstechnica.com/ai/2026/07/robot-workers-rising-how-ai-may-drive-general-purpose-autonomy-in-robotics/"
hn_url: "https://news.ycombinator.com/item?id=48832288"
title: "How AI could enable autonomous robot workers in workplaces–and maybe homes"
article_title: "How AI could enable autonomous robot workers in workplaces—and maybe homes - Ars Technica"
author: "JeanKage"
captured_at: "2026-07-08T15:12:14Z"
capture_tool: "hn-digest"
hn_id: 48832288
score: 1
comments: 0
posted_at: "2026-07-08T14:16:43Z"
tags:
  - hacker-news
  - translated
---
...
- HN: [48832288](https://news.ycombinator.com/item?id=48832288)
- Source: [arstechnica.com](https://arstechnica.com/ai/2026/07/robot-workers-rising-how-ai-may-drive-general-purpose-autonomy-in-robotics/)
- Score: 1
- Comments: 0
- Posted: 2026-07-08T14:16:43Z

## Translation

タイトル: AI が職場、そしておそらく家庭で自律型ロボット労働者をどのように実現できるか
記事タイトル: AI はどのようにして職場、そしておそらく家庭で自律ロボット労働者を可能にするのか - Ars Technica
説明: ロボット工学のトップ研究者と創設者が、ロボットの自律性がどのように進化しているかを説明します。
...
142
Agility の人型ロボット Digit は、倉庫や工場の現場で働いています。
クレジット:
アジリティロボティクス
Agility の人型ロボット Digit は、倉庫や工場の現場で働いています。
クレジット:
...
さらに詳しく
ナビゲーション用に最小化する
自動運転ロボタクシーがドライバーがハンドルを握ることなく都市の主要道路を滑走し、配送ドローンが自律的に空を飛行して顧客の家に注文品を届ける世界では、汎用ロボットが職場や家庭でさえも人間のさまざまなタスクを支援するというアイデアは、突飛なものではないように思えるかもしれません。
しかし、その未来は現代の人工知能を活用した自律性の高まるロボットの開発にかかっています。この野心的なビジョンは、多くの研究者をスタートアップの創設者にしようとする動機となり、同時に数十億ドルの投資を集めています。
「おそらく 15 年ほど前に私がプロジェクトを始めたとき、私は自律性に重点を置いたプロジェクト チームを率いていましたが、当時のチームの目標は、ロボットに地点 A から地点 B まで移動させることだけでした」と、マサチューセッツ州ウォルサムに本拠を置くロボット工学会社ボストン ダイナミクスのソフトウェア担当副社長マット マルカーノ氏は述べています。 「そして今、自律性について考えるとき、私たちはタスクやできることの巨大な空間を思い浮かべます。

ロボットが勝手に行動するところを想像してみてください。」
以前は、『ジェットソンズ』の家政婦ロージーのような汎用の自律ロボットや、『スター・ウォーズ』の C-3PO のようなさまざまなドロイドを作成するための実用的な道筋を想像することは、特にロボット研究室や企業が歩行ロボットの場合、自律ナビゲーションや自己バランスの解決にまだ苦戦していた時代には困難でした。 1979 年、スタンフォード カートとして知られる実験用自動運転車は、障害物でいっぱいの部屋を 20 メートル移動するのに 5 時間を要しました。バランスを崩さずに自立歩行できる世界初の二足歩行ロボットは1996年に開発された。
しかし、ロボットの自律性は常に「動く目標」であり、理想的には人間の直接の監督なしで、人間がすでに実行できることのますます大きなサブセットをロボットが実行できるようになるという目標を掲げているとマルカーノ氏はアルスに語った。国際標準化機構は、ロボット工学における自律性を「人間の介入なしに、現在の状態とセンシングに基づいて意図されたタスクを実行する能力」と定義しています。
2010年代の強化学習や2020年代の膨大な量のデータで訓練された大規模な基礎モデルなど、最近のAIの進歩により、「ロボットが一連の活動を実行し、タスクを実際に理解できる世界を想像することができ、それは非常にエキサイティングな」能力が「解放」されたとマルカーノ氏は語った。現在、複数の研究機関や企業が、より複雑で予測不可能な環境でさまざまなタスクを独立して処理できる汎用ロボットの開発を競っている。
このようなロボットは、多額の投資家が人型ロボットに投じているにもかかわらず、必ずしも外観や機能が人型であるとは限りません。しかし、その形が何であれ、それらは重要なステップを表す可能性があります。

すでに、工場や倉庫の比較的制御された環境内で特定のタスクを実行している何百万もの産業用ロボットやサービス ロボットを超えています。
「組み立てラインがあり、ロボットは特定の動作を行うことになっており、その動作を確実かつ繰り返し実行すれば、それは基本的な工場レベルの自律性となります」とカリフォルニア大学バークレー校のコンピュータ科学者であり、AIおよびロボット工学の会社フィジカル・インテリジェンスの共同創設者であるセルゲイ・レバイン氏は述べています。 「しかし、次のレベルは、現実世界に進出しつつある研究テーマなど、現在可能性の限界にあるレベルであり、構造化されていない環境でもロボットが確実に何かを実行できるということです。」
アルスは、AI によってロボット工学への関心がどのように高まっているか、汎用ロボットの製造の課題、ロボット作業者にとって安全性がいかに勝敗を左右するか、手術用ロボットの自律性がまだ限られている理由、そして家庭にロボットヘルパーがいつ登場するのかについて、ロボット研究者や創設者にインタビューしました。
最新の AI がロボット工学に与える影響
レバイン氏のスタートアップ企業「Physical Intelligence」は、オープンワールド環境で自律的に動作するさまざまなタイプのロボットを強化できる実用的なロボット知能の実現に取り組んでいる。 「何でもできる超高度なヒューマノイドのような究極のロボットになるとは思いません」とレバイン氏はアルスに語った。 「これは、仕事に適したさまざまなロボットに動力を供給できる、一般的な AI モデルになると思います。」
たとえば、ニューヨーク市の小さなアパートには、天井から吊るされた小さなロボットアームの方が適しているかもしれないが、農場では重い物体を動かす「巨大な巨大ロボット」の方が便利かもしれない、とレバイン氏は示唆した。 「きっと私達も良い暮らしができると思いますよ」

「マノイドだけでなく、他のものもあるでしょう。」と彼は言いました、「その仕事にとって最も意味のあるものは何でもあるでしょう。」
しかし、オープンワールドでより独立して動作できる自律ロボットの開発には、「技術的な複雑さの段階的な変化」が伴うとレバイン氏は言う。同氏は、こうしたロボットは複雑な環境認識を処理する必要があり、堅牢な運動能力と、基本的な間違いを克服して人間からの指示を処理する能力が必要であると説明した。さらに、そのようなロボットは、新しい状況に対処するために自分の行動を一般化する方法を学習する必要があります。
レバイン氏によると、多くの研究者が、強化学習を含むAI技術と事前訓練された大規模なモデルを組み合わせてこれを実現しようとしているという。強化学習には、現実世界と対話する物理的なロボットを使用する場合でも、コンピューター シミュレーションを使用する場合でも、試行錯誤を通じて特定のタスクを実行するようにロボットをトレーニングすることが含まれます。同時に、画像やテキストでトレーニングされた視覚言語モデルなど、膨大な量のデータで事前トレーニングされた基礎モデルは、世界に関する基本的な事前知識を提供し、ロボットがより適切に反応し、さまざまな状況で不必要な間違いを回避できるようにすることができます。
「強化学習とは、テニスのスイングを何度も練習すると、本当に上手になるのと似ています」とレバイン氏は説明した。 「しかし、そこに到達するには、まず、始めるための基本的な常識のようなものを持っている必要があります。」
AI技術と、人間がロボットを遠隔操作して特定のタスクの実行方法を示すなど、アクセス可能なトレーニングデータの段階的な拡大との組み合わせにより、さまざまな条件下で多くの異なるタスクを確実に実行するロボットのトレーニングの進歩を「促進」することが可能になったとレバイン氏は述べた。 「最新の機械学習システムを作るための鍵」

work is to get enough of a critical mass of data so that we see generalization,” he said.
しかし、ロボットが物理的な作業を実行できるようにトレーニングするための適切なデータを十分に収集することに関しては、依然としてデータのギャップが広く認識されています。よりコストと時間がかかる方法では、人間が遠隔操作リグを装着してロボットの物理的な動きを直接誘導し、研究室やその他の環境でロボットを使用してトレーニングや多くの実験を実施します。物理学に基づいて手動でコード化されたシミュレーションは、仮想環境でより安価にロボットを訓練するのに役立ちますが、現実世界の多くの複雑さや不確実性を把握できない可能性があります。
ロボット研究者は、ロボットが物理世界での行動の結果を予測し、それに応じて計画を立てるのに役立つ世界モデルも開発しています。このような AI モデルの一部の実装は、物理環境がどのように機能するかを学習するために主に視覚データに基づいてトレーニングされており、一部の企業では、家事やその他の作業を行うときにヘッドマウント カメラを装着するギグ ワーカーを雇い、トレーニング データ用の一人称ビデオを収集することさえあります。
ロボット トレーニングへのこのアプローチは、現実世界のロボット実験を実行するよりも安価ですが、ワールド モデルの開発には依然として計算コストがかかり、現実世界の物理的相互作用を正確に再現するのが難しい場合もあります。
For now, general-purpose robots remain on the horizon.強化学習などの現在のトレーニング方法では、非常に特殊な条件下で特定のタスクを一貫して実行することに非常に優れたロボットを生成できますが、そのようなロボットは、異なる条件下では同じタスクでたどたどしい場合があります。一方、遠隔操作やその他の方法から得られるデータの多様性は、ロボットを訓練して「多様なタスクを学習させることはできるが、99.99% レベルの堅牢性には達していない」
...
Fortunately, the world won’t need to wait for the development of general-purpose robotic capabilities to find practical uses for robots.多くの企業は、すでに何十年もの間、特殊な産業用ロボットやサービスロボットを開発、販売してきました。そして、新興のスタートアップ企業とより確立されたロボット企業の両方が、増大する一連のタスクの処理に向けて、すでに最新レベルのロボット自律性を適用しています。
最もよく知られた競合企業の 1 つは、もともと 1992 年に MIT の研究所からスピンアウトしたボストン ダイナミクスです。このロボット工学会社は、四足歩行ロボットと二足歩行ロボットのバイラルビデオデモンストレーションで広く知られており、最新の例としては、2026 年ワールドカップ中にサッカーのさまざまな動きを学習する同社の人型ロボット Atlas が挙げられます。
しかし、ボストン・ダイナミクスの四足歩行ロボットは数年前から、電気・ガス事業会社ナショナル・グリッドが運営するマサチューセッツ州の変電所やカリフォルニア州の高速道路の下を走る暗渠管など、人間にとってより危険な施設の自律点検を行っている。
このようなロボットの自律性とは、「実際には、そのロボットが環境内を移動し、その環境の写真を撮ったりセンサーで測定したりして、独自に行動を実行する能力に関するものです」とマルカーノ氏は述べた。 「これは私たちが製品にパッケージ化した機能であり、ロボット工学者ではなく、設備を本当にうまく機能させ、故障しないようにすることに重点を置いている人々が使用できるように販売しているだけです。これは自動車の一種です」

今日利用できるのはノミーです。」
Spot にとっての特別な課題の 1 つは、顧客施設の滑りやすい床の上を歩く学習であり、強化学習による追加のトレーニングが必要でした。 「私たちは、ロボットがどのように歩くことを選択するのか、そして滑りやすい床の上にあることを認識し、安定を保つための行動をとり、人間が氷の上を歩くのと同じようにその上を移動できるようにする能力を再訓練しました」とマルカーノ氏は説明した。
同時に、大型ロボットアームを備えた同社の車輪付きストレッチロボットは、DHL などの物流会社が運営する倉庫で大きな箱や荷物を扱っています。 「私たちは、現実世界と対話することで遭遇した、荷物のさまざまな形、トラックの積み込み方法、トラック自体の構造に継続的に適応させてきました」とマルカーノ氏はアルスに語った。
ボストン・ダイナミクスは現在、全電気式人型ロボット「アトラス」の製造も強化している。この人型ロボットは、韓国の親会社である現代自動車グループが運営するロボット メタプラント アプリケーション センターでトレーニングとテストを受けています。目標は、2028 年までに、ジョージア州エラベルにある巨大な電気自動車工場である現代自動車グループのメタプラント アメリカで作業を実行するアトラス ロボットを訓練することです。
「ヒュンダイと提携できたことは非常に幸運だったと思います。ヒュンダイは明らかに素晴らしい製品を生産しています」
...
Sign in dialog...
Sign in
Look for the robot helpers
How AI could enable autonomous robot workers in workplaces—and maybe homes
Top robotics researchers and founders explain how robot autonomy is evolving.
142
Agility's Digit humanoid robots are working in warehouses and on factory floors.
Credit:
Agility Robotics
Agility's Digit humanoid robots are working in warehouses and on factory floors.
Credit:
...
“I think we’re very lucky to be affiliated with Hyundai, which obviously produces fant
