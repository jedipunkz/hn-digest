...
hn_url: "https://news.ycombinator.com/item?id=49068422"
title: "Show HN: Aitori, see and govern the AI traffic leaving your machine"
article_title: "GitHub - truefoundry/aitori · GitHub"
author: "deeptishukla22"
captured_at: "2026-07-27T12:51:37Z"
capture_tool: "hn-digest"
hn_id: 49068422
score: 2
comments: 1
posted_at: "2026-07-27T12:05:23Z"
tags:
  - hacker-news
  - translated
---
...
- HN: [49068422](https://news.ycombinator.com/item?id=49068422)
- Source: [github.com](https://github.com/truefoundry/aitori/)
- Score: 2
- Comments: 1
- Posted: 2026-07-27T12:05:23Z

## Translation

タイトル: HN を表示: Aitori、マシンから出る AI トラフィックを確認して管理する
記事タイトル: GitHub - truefoundry/aitori · GitHub
説明: GitHub でアカウントを作成して、truefoundry/aitori の開発に貢献します。
HN テキスト: こんにちは、HN、私は TrueFoundry で働いています。 AI トラフィックを企業が制御することが難しくなっているため、Aitori を構築しました。開発者が LLM API を直接呼び出すと、リクエストはゲートウェイ経由でルーティングできます。ただし、Claude Desktop、ChatGPT アプリ、claude.ai などのツールは、ベンダーのバックエンドからモデルを呼び出します。プロキシを指定できるエンドポイント設定はありません。 Aitori は、従業員のマシン上で実行され、選択された AI アプリケーションへのトラフィックを傍受するオープンソースのローカル プロキシです。 mitmproxy と同様のデバイスごとの CA を使用して、モデルおよび MCP リクエストを検査し、ゲートウェイに転送します。他のアプリケーションへのトラフィックはそのまま残されます。トラフィックが見えるようになると、トラフィックはブラック ボックスではなくなります。ログに記録したり、ポリシーを適用したり、ルーティングしたり、制御する AI トラフィックに対して行うことであれば何でも行うことができます。これは Apache-2.0 であり、転送コントラクトが文書化されているため、私たちのゲートウェイだけでなく、どのゲートウェイでも動作します: https://github.com/truefoundry/aitori/ 試してみてください:
カール -fsSL https://raw.githubusercontent.com/truefoundry/aitori/main/in... |しー
それから
sudo aitori up --ui 質問があれば一日中答えます。
...
イオン。それ以外のものはすべてそこに直行します。リクエストの仕組み
...
ゲートウェイは実装する必要があります。 TrueFoundry A 用

I ゲートウェイ、正確な URL とトークン
